...
abstract class ConfigurationClassUtils {
	...
	// 非@Configuration注解标注的类，将属性值标注为lite
	...
	public static boolean checkConfigurationClassCandidate(
		...
		// spring内部的db是RootBeanDefinition，实现了AbstractBeanDefinition
		...
		// 如果bean被@Configuration注解标注,且被注解@Component，@ComponentScan，@Import，@ImportResource或者@Bean
		// 标记的方法，则将bean定义标记为lite
		...
		// bean定义是一个标记full或者lite的候选项，如果设置order则设置order属性值
		Integer order = getOrder(metadata);
		// 如果值为空的话，那么直接设置值到具体的beanDefinition
		if (order != null) {
			// 设置bean定义的order值
